<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Asics.aspx.cs" Inherits="UrbanKicks.Asics" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <title>Asics Products - Urban Kicks</title>
    <style>
        .product-grid {
            display: grid;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main>
      ...
      <div class="sort-filter">
        ...
        <h2 class="nike-heading">Asics Products</h2>
    </div>

      
        <div class="product-grid" id="productGrid">
            <asp:Repeater ID="AsicsProductList" runat="server">
                <ItemTemplate>
