<%@ Page Title="New Balance Products" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="NewBalance.aspx.cs" Inherits="UrbanKicks.NewBalance" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>New Balance - UrbanKicks</title>
    <style>
        .product-grid {
            display: grid;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main>
        ...
        <h2 class="nike-heading">New Balance Products</h2>
    </div>

         <div class="product-grid" id="productGrid">
            <asp:Repeater ID="NewBalanceProductList" runat="server">
                <ItemTemplate>
