<%@ Page Title="Nike Products" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Nike.aspx.cs" Inherits="UrbanKicks.Nike" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Nike Products - Urban Kicks</title>
    <style>
        .product-grid {
            display: grid;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main>
      ...
      <div class="sort-filter">
        ...
        <h2 class="nike-heading">Nike Products</h2>
    </div>
        ...
        <div class="product-grid" id="productGrid">
            <asp:Repeater ID="NikeProductList" runat="server">
                <ItemTemplate>
