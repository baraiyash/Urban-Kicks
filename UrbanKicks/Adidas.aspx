<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Adidas.aspx.cs" Inherits="UrbanKicks.Adidas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <main>
        ...
        <h2 class="nike-heading">Adidas Products</h2>
    </div>

         <div class="product-grid" id="productGrid">
            <asp:Repeater ID="AdidasProductList" runat="server">
                <ItemTemplate>
